...
## Why Choose SENDUNE Email Designer?
...
Comes with three template types that let you design any kind of transactional or marketing emails. Altogether, you can create and save unlimited templates.
...
```
npm install @enley-es/ng-email-designer
```

Or via YARN:

```
yarn add @enley-es/ng-email-designer
```
...
```css
@import '../node_modules/@enley-es/ng-email-designer/src/lib/theme.scss';
@import '../node_modules/@enley-es/ng-email-designer/src/lib/email-editor.css';
```
